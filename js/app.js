import { newReview, addComment, updateComment, deleteComment, setDecision, partitionByDecision, queueApproved } from './model.js?v=6ef7e9f';
import { anchorFromSelection } from './anchor.js?v=6ef7e9f';
import { reviewPath, mergeReview, getJson, putJson, ghTree, putFile, getDataUrl, deleteFile } from './gh.js?v=6ef7e9f';
import { PROVIDERS, detectProvider, genKey, getPublicKey, putSecret, setVariable, dispatchInvite, latestRun, dispatchRender, renderRun, setAiSecrets, dispatchApply, applyRun, applyRunLabel, listSecretNames, claudeConnectionStatus, prefillFromGitHub, isScopeError, checkActionsAccess, permissionFromError } from './ghsecrets.js?v=6ef7e9f';
import { ensureRenderPipeline, ensureApplyEngine, ensureInvitePipeline } from './seed.js?v=6ef7e9f';
import { sealToBase64 } from './vendor/seal.js?v=6ef7e9f';
import { isConfigured as ghAppConfigured, startDeviceLogin, pollForToken } from './ghauth.js?v=6ef7e9f';
import { startTour, tourSeen, markTourSeen } from './tour.js?v=6ef7e9f';
import { loadConfig, dataRepoParts, loadChapters, loadProjects, resolveProject, setConfig, writeProjectPatch, assistantEnabled, sendMenuActions, dataPath, advisorInviteUrl, sourceLabel } from './config.js?v=6ef7e9f';
import { loadAgentCatalog, agentCatalogView, agentCatalogHtml, partitionCatalog, buildAuthorJob, approveAuthored, deleteAuthored, editAuthored, writeAgentsJson } from './agentcatalog.js?v=6ef7e9f';
import { orderedUnits, mergeReviews, routeWrite, wrapUnit, stripSegmentId } from './wholedoc.js?v=6ef7e9f';
...
import { parseLatexChapters, detectUnitLevel, resolveUnitNoun, parseDocxChapters, docxToXml } from './docparse.js?v=6ef7e9f';
import { importFormat, stagingPath, sourceRepoSuggestion, ensureRepo, repoFileSha, commitSourceFile, commitSourceBinary, pickEntryTex, stripTopFolder, isTextPath } from './importdoc.js?v=6ef7e9f';
import { inviteReadiness, healthSignals, reviewerStatus, restoreAdvisorPlan, renderBuiltStatus, emailTestOutcome } from './owneradmin.js?v=6ef7e9f';
import { buildWorklist, worklistToMarkdown, worklistToHtml } from './worklist.js?v=6ef7e9f';
import { startWatch as startNetWatch } from './netstatus.js?v=6ef7e9f';
import { settingsSections, resolveSection } from './settings.js?v=6ef7e9f';
import { modalReducer, topModal } from './modal.js?v=6ef7e9f';
import { showBuildTag } from './buildinfo.js?v=6ef7e9f';
import { readProgress } from './cardstats.js?v=6ef7e9f';
import { isChecklistDismissed, dismissChecklist, restoreChecklist } from './relchecklist.js?v=6ef7e9f';
import { resolveReviewerName } from './reviewername.js?v=6ef7e9f';
startNetWatch();
