import { newReview, addComment, updateComment, deleteComment, setDecision, partitionByDecision, queueApproved } from './model.js?v=1f08e80';
import { anchorFromSelection } from './anchor.js?v=1f08e80';
import { reviewPath, mergeReview, getJson, putJson, ghTree, putFile, getDataUrl, deleteFile } from './gh.js?v=1f08e80';
import { PROVIDERS, detectProvider, genKey, getPublicKey, putSecret, setVariable, dispatchInvite, latestRun, prefillFromGitHub, isScopeError } from './ghsecrets.js?v=1f08e80';
import { sealToBase64 } from './vendor/seal.js?v=1f08e80';
import { isConfigured as ghAppConfigured, startDeviceLogin, pollForToken } from './ghauth.js?v=1f08e80';
import { startTour, tourSeen, markTourSeen } from './tour.js?v=1f08e80';
import { loadConfig, dataRepoParts, loadChapters, loadProjects, resolveProject, setConfig } from './config.js?v=1f08e80';
import { parseLatexChapters, parseDocxChapters, docxToXml } from './docparse.js?v=1f08e80';
