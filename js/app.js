import { newReview, addComment, updateComment, deleteComment, setDecision, partitionByDecision, queueApproved } from './model.js?v=79b46e8';
import { anchorFromSelection } from './anchor.js?v=79b46e8';
import { reviewPath, mergeReview, getJson, putJson, ghTree, putFile, getDataUrl, deleteFile } from './gh.js?v=79b46e8';
import { PROVIDERS, detectProvider, genKey, getPublicKey, putSecret, setVariable, dispatchInvite, latestRun, dispatchRender, renderRun, setAiSecrets, dispatchApply, applyRun, applyRunLabel, listSecretNames, claudeConnectionStatus, prefillFromGitHub, isScopeError, checkActionsAccess, permissionFromError } from './ghsecrets.js?v=79b46e8';
import { ensureRenderPipeline, ensureApplyEngine, ensureInvitePipeline } from './seed.js?v=79b46e8';
import { sealToBase64 } from './vendor/seal.js?v=79b46e8';
import { isConfigured as ghAppConfigured, startDeviceLogin, pollForToken } from './ghauth.js?v=79b46e8';
import { startTour, tourSeen, markTourSeen } from './tour.js?v=79b46e8';
import { loadConfig, dataRepoParts, loadChapters, loadProjects, resolveProject, setConfig, writeProjectPatch, assistantEnabled, dataPath, advisorInviteUrl, sourceLabel } from './config.js?v=79b46e8';
import { loadAgentCatalog, agentCatalogView, agentCatalogHtml } from './agentcatalog.js?v=79b46e8';
import { orderedUnits, mergeReviews, routeWrite, wrapUnit, stripSegmentId } from './wholedoc.js?v=79b46e8';
import { parseLatexChapters, detectUnitLevel, resolveUnitNoun, parseDocxChapters, docxToXml } from './docparse.js?v=79b46e8';
import { importFormat, stagingPath, sourceRepoSuggestion, ensureRepo, repoFileSha, commitSourceFile, commitSourceBinary, pickEntryTex, stripTopFolder, isTextPath } from './importdoc.js?v=79b46e8';
import { inviteReadiness, healthSignals, reviewerStatus, restoreAdvisorPlan, renderBuiltStatus, emailTestOutcome } from './owneradmin.js?v=79b46e8';
import { buildWorklist, worklistToMarkdown, worklistToHtml } from './worklist.js?v=79b46e8';
import { startWatch as startNetWatch } from './netstatus.js?v=79b46e8';
import { settingsSections, resolveSection } from './settings.js?v=79b46e8';
import { modalReducer, topModal } from './modal.js?v=79b46e8';
startNetWatch();
