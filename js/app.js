import { newReview, addComment, updateComment, deleteComment, setDecision, partitionByDecision, queueApproved } from './model.js?v=0afc32b';
import { anchorFromSelection } from './anchor.js?v=0afc32b';
import { reviewPath, mergeReview, getJson, putJson, ghTree, putFile, getDataUrl, deleteFile } from './gh.js?v=0afc32b';
import { PROVIDERS, detectProvider, genKey, getPublicKey, putSecret, setVariable, dispatchInvite, latestRun, dispatchRender, renderRun, setAiSecrets, dispatchApply, applyRun, applyRunLabel, listSecretNames, claudeConnectionStatus, prefillFromGitHub, isScopeError, checkActionsAccess, permissionFromError } from './ghsecrets.js?v=0afc32b';
import { ensureRenderPipeline, ensureApplyEngine, ensureInvitePipeline } from './seed.js?v=0afc32b';
import { sealToBase64 } from './vendor/seal.js?v=0afc32b';
import { isConfigured as ghAppConfigured, startDeviceLogin, pollForToken } from './ghauth.js?v=0afc32b';
import { startTour, tourSeen, markTourSeen } from './tour.js?v=0afc32b';
import { loadConfig, dataRepoParts, loadChapters, loadProjects, resolveProject, setConfig, writeProjectPatch, assistantEnabled, sendMenuActions, dataPath, advisorInviteUrl, sourceLabel } from './config.js?v=0afc32b';
import { loadAgentCatalog, agentCatalogView, agentCatalogHtml, partitionCatalog, buildAuthorJob, approveAuthored, deleteAuthored, editAuthored, writeAgentsJson } from './agentcatalog.js?v=0afc32b';
import { orderedUnits, mergeReviews, routeWrite, wrapUnit, stripSegmentId } from './wholedoc.js?v=0afc32b';
...
import { parseLatexChapters, detectUnitLevel, resolveUnitNoun, parseDocxChapters, docxToXml } from './docparse.js?v=0afc32b';
import { importFormat, stagingPath, sourceRepoSuggestion, ensureRepo, repoFileSha, commitSourceFile, commitSourceBinary, pickEntryTex, stripTopFolder, isTextPath } from './importdoc.js?v=0afc32b';
import { inviteReadiness, healthSignals, reviewerStatus, restoreAdvisorPlan, renderBuiltStatus, emailTestOutcome } from './owneradmin.js?v=0afc32b';
import { buildWorklist, worklistToMarkdown, worklistToHtml } from './worklist.js?v=0afc32b';
import { startWatch as startNetWatch } from './netstatus.js?v=0afc32b';
import { settingsSections, resolveSection } from './settings.js?v=0afc32b';
import { modalReducer, topModal } from './modal.js?v=0afc32b';
import { showBuildTag } from './buildinfo.js?v=0afc32b';
import { readProgress } from './cardstats.js?v=0afc32b';
import { isChecklistDismissed, dismissChecklist, restoreChecklist } from './relchecklist.js?v=0afc32b';
import { resolveReviewerName } from './reviewername.js?v=0afc32b';
startNetWatch();
