import { newReview, addComment, updateComment, deleteComment, setDecision, partitionByDecision, queueApproved } from './model.js?v=ed8337b';
import { anchorFromSelection } from './anchor.js?v=ed8337b';
import { reviewPath, mergeReview, getJson, putJson, ghTree, putFile, getDataUrl, deleteFile } from './gh.js?v=ed8337b';
import { PROVIDERS, detectProvider, genKey, getPublicKey, putSecret, setVariable, dispatchInvite, latestRun, dispatchRender, renderRun, setAiSecrets, dispatchApply, applyRun, applyRunLabel, listSecretNames, claudeConnectionStatus, prefillFromGitHub, isScopeError, checkActionsAccess, permissionFromError } from './ghsecrets.js?v=ed8337b';
import { ensureRenderPipeline, ensureApplyEngine, ensureInvitePipeline } from './seed.js?v=ed8337b';
import { sealToBase64 } from './vendor/seal.js?v=ed8337b';
import { isConfigured as ghAppConfigured, startDeviceLogin, pollForToken } from './ghauth.js?v=ed8337b';
import { startTour, tourSeen, markTourSeen } from './tour.js?v=ed8337b';
import { loadConfig, dataRepoParts, loadChapters, loadProjects, resolveProject, setConfig, writeProjectPatch, assistantEnabled, sendMenuActions, dataPath, advisorInviteUrl, sourceLabel } from './config.js?v=ed8337b';
import { loadAgentCatalog, agentCatalogView, agentCatalogHtml, partitionCatalog, buildAuthorJob, approveAuthored, deleteAuthored, editAuthored, writeAgentsJson } from './agentcatalog.js?v=ed8337b';
import { orderedUnits, mergeReviews, routeWrite, wrapUnit, stripSegmentId } from './wholedoc.js?v=ed8337b';
import { buildRefsSection } from './wholerefs.js?v=ed8337b';   // consolidate scattered per-unit reference lists into one at the end of the whole-doc
import { unitLabel, unitLabelWithTitle } from './unitlabel.js?v=ed8337b';   // "Chapter 3" / "Appendix A" — one label rule for both portals
import { parseLatexChapters, detectUnitLevel, resolveUnitNoun, parseDocxChapters, docxToXml } from './docparse.js?v=ed8337b';
import { importFormat, stagingPath, sourceRepoSuggestion, ensureRepo, repoFileSha, commitSourceFile, commitSourceBinary, pickEntryTex, stripTopFolder, isTextPath } from './importdoc.js?v=ed8337b';
import { inviteReadiness, healthSignals, reviewerStatus, restoreAdvisorPlan, renderBuiltStatus, emailTestOutcome } from './owneradmin.js?v=ed8337b';
import { buildWorklist, worklistToMarkdown, worklistToHtml } from './worklist.js?v=ed8337b';
import { startWatch as startNetWatch } from './netstatus.js?v=ed8337b';
import { settingsSections, resolveSection } from './settings.js?v=ed8337b';
import { modalReducer, topModal } from './modal.js?v=ed8337b';
import { showBuildTag } from './buildinfo.js?v=ed8337b';
import { readProgress } from './cardstats.js?v=ed8337b';
import { isChecklistDismissed, dismissChecklist, restoreChecklist } from './relchecklist.js?v=ed8337b';
import { resolveReviewerName } from './reviewername.js?v=ed8337b';
startNetWatch();
