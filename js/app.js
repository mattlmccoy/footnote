import { newReview, addComment, updateComment, deleteComment, setDecision, partitionByDecision, queueApproved } from './model.js?v=3ac23cb';
import { anchorFromSelection } from './anchor.js?v=3ac23cb';
import { reviewPath, mergeReview, getJson, putJson, ghTree, putFile, getDataUrl, deleteFile } from './gh.js?v=3ac23cb';
import { PROVIDERS, detectProvider, genKey, getPublicKey, putSecret, setVariable, dispatchInvite, latestRun, prefillFromGitHub, isScopeError } from './ghsecrets.js?v=3ac23cb';
import { sealToBase64 } from './vendor/seal.js?v=3ac23cb';
import { isConfigured as ghAppConfigured, startDeviceLogin, pollForToken } from './ghauth.js?v=3ac23cb';
import { startTour, tourSeen, markTourSeen } from './tour.js?v=3ac23cb';
import { loadConfig, dataRepoParts, loadChapters, loadProjects, resolveProject, setConfig } from './config.js?v=3ac23cb';
import { parseLatexChapters, parseDocxChapters, docxToXml } from './docparse.js?v=3ac23cb';
