import { newReview, addComment, updateComment, deleteComment, setDecision, partitionByDecision, queueApproved } from './model.js?v=ae77489';
import { anchorFromSelection } from './anchor.js?v=ae77489';
import { reviewPath, mergeReview, getJson, putJson, ghTree, putFile, getDataUrl, deleteFile } from './gh.js?v=ae77489';
import { PROVIDERS, detectProvider, genKey, getPublicKey, putSecret, setVariable, dispatchInvite, latestRun, dispatchRender, renderRun, setAiSecrets, dispatchApply, applyRun, applyRunLabel, listSecretNames, claudeConnectionStatus, prefillFromGitHub, isScopeError, checkActionsAccess, permissionFromError } from './ghsecrets.js?v=ae77489';
import { ensureRenderPipeline, ensureApplyEngine, ensureInvitePipeline } from './seed.js?v=ae77489';
import { sealToBase64 } from './vendor/seal.js?v=ae77489';
import { isConfigured as ghAppConfigured, startDeviceLogin, pollForToken } from './ghauth.js?v=ae77489';
import { startTour, tourSeen, markTourSeen } from './tour.js?v=ae77489';
import { loadConfig, dataRepoParts, loadChapters, loadProjects, resolveProject, setConfig, writeProjectPatch, assistantEnabled, sendMenuActions, dataPath, advisorInviteUrl, sourceLabel } from './config.js?v=ae77489';
import { loadAgentCatalog, agentCatalogView, agentCatalogHtml, partitionCatalog, buildAuthorJob, approveAuthored, deleteAuthored, editAuthored, writeAgentsJson } from './agentcatalog.js?v=ae77489';
import { orderedUnits, mergeReviews, routeWrite, wrapUnit, stripSegmentId } from './wholedoc.js?v=ae77489';
import { buildRefsSection } from './wholerefs.js?v=ae77489';   // consolidate scattered per-unit reference lists into one at the end of the whole-doc
import { unitLabel, unitLabelWithTitle } from './unitlabel.js?v=ae77489';   // "Chapter 3" / "Appendix A" — one label rule for both portals
import { parseLatexChapters, detectUnitLevel, resolveUnitNoun, parseDocxChapters, docxToXml } from './docparse.js?v=ae77489';
import { importFormat, stagingPath, sourceRepoSuggestion, ensureRepo, repoFileSha, commitSourceFile, commitSourceBinary, pickEntryTex, stripTopFolder, isTextPath } from './importdoc.js?v=ae77489';
import { inviteReadiness, healthSignals, reviewerStatus, restoreAdvisorPlan, renderBuiltStatus, emailTestOutcome } from './owneradmin.js?v=ae77489';
import { buildWorklist, worklistToMarkdown, worklistToHtml } from './worklist.js?v=ae77489';
import { startWatch as startNetWatch } from './netstatus.js?v=ae77489';
import { settingsSections, resolveSection } from './settings.js?v=ae77489';
import { modalReducer, topModal } from './modal.js?v=ae77489';
import { showBuildTag } from './buildinfo.js?v=ae77489';
import { readProgress } from './cardstats.js?v=ae77489';
import { isChecklistDismissed, dismissChecklist, restoreChecklist } from './relchecklist.js?v=ae77489';
import { resolveReviewerName } from './reviewername.js?v=ae77489';
startNetWatch();
