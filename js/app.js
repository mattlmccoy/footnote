...
import { themeIconName } from './themeicon.js?v=a4da5aa';   // theme toggle icon (sun in dark, moon in light)
...
import { helpFabRight, positionFab, watchFabLayout } from './fablayout.js?v=3d85aeb';   // help button sits beside the word-count pill
...
import { initAccent, swatchesHtml, chooseAccent, storedAccent, celebrate, withColorEasterEgg, celebrateCardFill } from './accent.js?v=8f4c423';
import { modalReducer, topModal } from './modal.js?v=aa8d478';
import { showBuildTag } from './buildinfo.js?v=2e84ce0';
import { readProgress, chapterMilestones, newMilestones, newlyCompleteCards, parseCelebrated, addCelebrated } from './cardstats.js?v=9814102';
...
import { isAiComment, buildAdvisorClaudeJob, partitionAdvisorComments, findingCardState, isClaudeReview } from './aicomment.js?v=c252c31';
startNetWatch();
...
function buildCommentCard(c){
    ...
    card.innerHTML = `<div class="row">
        ${isClaudeReview(c)?'<span class="chip" style="background:var(--info-bg);color:var(--info)"><i class="ti ti-robot-face" style="font-size:11px;vertical-align:-1px;margin-right:3px"></i>Claude · review</span>':''}
...
function enterHome(){
  ...
  document.getElementById('topbar').innerHTML =
    `<a href="./index.html" title="Your projects" style="text-decoration:none;color:inherit;display:inline-flex;align-items:center;gap:8px"><svg width="20" height="20" viewBox="0 0 52 52" style="flex:0 0 auto"><rect x="3" y="3" width="46" height="46" rx="12" fill="var(--accent)"/><line x1="19" y1="14" x2="19" y2="38" stroke="#fff" stroke-width="3" stroke-linecap="round"/><line x1="26" y1="18" x2="38" y2="18" stroke="#fff" stroke-width="3" stroke-linecap="round" opacity=".5"/><line x1="26" y1="26" x2="38" y2="26" stroke="#fff" stroke-width="3" stroke-linecap="round" opacity=".5"/><circle cx="19" cy="26" r="4.6" fill="#fff"/></svg><strong style="font-size:16px;font-weight:600">${escapeHtml(_CFG.brand.name)}</strong></a>
