...
import { wordDiff } from './textdiff.js?v=6696df8';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=6696df8';   // instance config + chapter manifest; assistant-free by construction
import { keyFromSearch, searchWithoutKey } from './invite.js?v=6696df8';   // magic-link: key in the invite URL
