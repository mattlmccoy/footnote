...
import { wordDiff } from './textdiff.js?v=55d4584';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=55d4584';   // instance config + chapter manifest; assistant-free by construction
