...
import { wordDiff } from './textdiff.js?v=3966728';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=3966728';   // instance config + chapter manifest; assistant-free by construction
