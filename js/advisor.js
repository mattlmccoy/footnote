...
import { fetchWithTimeout, classifyGitHubError, retryAfterMs, TTLCache, orphanComments } from './nethelpers.js?v=68b8b5d';   // bounded fetch + rate-limit backoff + read cache + orphan fallback
startNetWatch();
