...
import { wordDiff } from './textdiff.js?v=206cd93';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=206cd93';   // instance config + chapter manifest; assistant-free by construction
