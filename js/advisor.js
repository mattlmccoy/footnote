...
import { wordDiff } from './textdiff.js?v=5d13f48';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=5d13f48';   // instance config + chapter manifest; assistant-free by construction
