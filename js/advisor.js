...
import { wordDiff } from './textdiff.js?v=ef73fa1';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=ef73fa1';   // instance config + chapter manifest; assistant-free by construction
