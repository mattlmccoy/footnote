...
import { wordDiff } from './textdiff.js?v=4b01044';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=4b01044';   // instance config + chapter manifest; assistant-free by construction
import { keyFromSearch, searchWithoutKey } from './invite.js?v=4b01044';   // magic-link: key in the invite URL
