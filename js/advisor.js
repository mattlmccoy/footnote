...
import { wordDiff } from './textdiff.js?v=69a0da0';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=69a0da0';   // instance config + chapter manifest; assistant-free by construction
