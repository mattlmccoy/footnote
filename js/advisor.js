...
import { wordDiff } from './textdiff.js?v=17b5049';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=17b5049';   // instance config + chapter manifest; assistant-free by construction
