...
import { wordDiff } from './textdiff.js?v=b48c728';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=b48c728';   // instance config + chapter manifest; assistant-free by construction
