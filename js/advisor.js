...
import { wordDiff } from './textdiff.js?v=03d6c59';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=03d6c59';   // instance config + chapter manifest; assistant-free by construction
import { orderedUnits, mergeReviews as flattenReviews, routeWrite, wrapUnit, stripSegmentId } from './wholedoc.js?v=03d6c59';   // whole-document view helpers (pure)
