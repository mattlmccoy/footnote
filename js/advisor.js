...
import { wordDiff } from './textdiff.js?v=3621419';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=3621419';   // instance config + chapter manifest; assistant-free by construction
import { orderedUnits, mergeReviews as flattenReviews, routeWrite, wrapUnit, stripSegmentId } from './wholedoc.js?v=3621419';   // whole-document view helpers (pure)
