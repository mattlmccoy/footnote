...
import { wordDiff } from './textdiff.js?v=06523c1';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=06523c1';   // instance config + chapter manifest; assistant-free by construction
import { orderedUnits, mergeReviews as flattenReviews, routeWrite, wrapUnit, stripSegmentId } from './wholedoc.js?v=06523c1';   // whole-document view helpers (pure)
