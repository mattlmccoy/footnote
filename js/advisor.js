...
import { wordDiff } from './textdiff.js?v=062c019';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=062c019';   // instance config + chapter manifest; assistant-free by construction
