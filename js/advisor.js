...
import { wordDiff } from './textdiff.js?v=c88f709';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=c88f709';   // instance config + chapter manifest; assistant-free by construction
