...
import { wordDiff } from './textdiff.js?v=6c4d746';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=6c4d746';   // instance config + chapter manifest; assistant-free by construction
