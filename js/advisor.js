...
import { wordDiff } from './textdiff.js?v=a011de4';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=a011de4';   // instance config + chapter manifest; assistant-free by construction
