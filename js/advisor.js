...
import { wordDiff } from './textdiff.js?v=d7246b8';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=d7246b8';   // instance config + chapter manifest; assistant-free by construction
