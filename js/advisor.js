...
import { wordDiff } from './textdiff.js?v=efe4616';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=efe4616';   // instance config + chapter manifest; assistant-free by construction
