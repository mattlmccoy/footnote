...
import { wordDiff } from './textdiff.js?v=8f1c6ee';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=8f1c6ee';   // instance config + chapter manifest; assistant-free by construction
import { orderedUnits, mergeReviews as flattenReviews, routeWrite, wrapUnit, stripSegmentId } from './wholedoc.js?v=8f1c6ee';   // whole-document view helpers (pure)
