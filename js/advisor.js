...
import { wordDiff } from './textdiff.js?v=rev1';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=rev1';   // instance config + chapter manifest; assistant-free by construction
