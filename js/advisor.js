...
import { wordDiff } from './textdiff.js?v=8804b4a';
import { loadConfig, dataRepoParts, loadChapters } from './config.js?v=8804b4a';   // instance config + chapter manifest; assistant-free by construction
