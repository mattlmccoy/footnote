...
import { recentsKey, recentsAdd, recentsList, recentsRemove, entryKey, linkFor, newCount, pickAuthorName } from './reviewerhome.js?v=fa9ece1';   // remembered documents for the reviewer Home
