...
import { wordDiff } from './textdiff.js?v=fu1';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=fu1';   // instance config + chapter manifest; assistant-free by construction
