...
import { wordDiff } from './textdiff.js?v=1406ac8';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=1406ac8';   // instance config + chapter manifest; assistant-free by construction
