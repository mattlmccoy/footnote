...
import { wordDiff } from './textdiff.js?v=3ac23cb';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=3ac23cb';   // instance config + chapter manifest; assistant-free by construction
