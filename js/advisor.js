...
import { wordDiff } from './textdiff.js?v=72cf4f8';
import { loadConfig, dataRepoParts, loadChapters } from './config.js?v=72cf4f8';   // instance config + chapter manifest; assistant-free by construction
