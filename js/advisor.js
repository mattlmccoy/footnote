...
import { wordDiff } from './textdiff.js?v=582ac0d';
...
import { fetchWithTimeout, classifyGitHubError, retryAfterMs, TTLCache, orphanComments } from './nethelpers.js?v=582ac0d';   // bounded fetch + rate-limit backoff + read cache + orphan fallback
startNetWatch();
