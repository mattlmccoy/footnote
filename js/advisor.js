...
import { wordDiff } from './textdiff.js?v=9f90fb9';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=9f90fb9';   // instance config + chapter manifest; assistant-free by construction
