...
import { wordDiff } from './textdiff.js?v=96f40d8';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=96f40d8';   // instance config + chapter manifest; assistant-free by construction
