...
import { wordDiff } from './textdiff.js?v=ccd2b43';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=ccd2b43';   // instance config + chapter manifest; assistant-free by construction
