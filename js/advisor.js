...
import { wordDiff } from './textdiff.js?v=406ae14';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=406ae14';   // instance config + chapter manifest; assistant-free by construction
