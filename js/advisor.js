...
import { wordDiff } from './textdiff.js?v=dcbaba1';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=dcbaba1';   // instance config + chapter manifest; assistant-free by construction
