...
import { wordDiff } from './textdiff.js?v=367e8c5';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=367e8c5';   // instance config + chapter manifest; assistant-free by construction
