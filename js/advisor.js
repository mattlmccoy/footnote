...
import { wordDiff } from './textdiff.js?v=1c3b29c';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=1c3b29c';   // instance config + chapter manifest; assistant-free by construction
