...
import { wordDiff } from './textdiff.js?v=c55a5ba';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=c55a5ba';   // instance config + chapter manifest; assistant-free by construction
