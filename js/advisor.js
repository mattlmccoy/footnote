...
import { wordDiff } from './textdiff.js?v=f4347c3';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=f4347c3';   // instance config + chapter manifest; assistant-free by construction
