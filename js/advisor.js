...
import { wordDiff } from './textdiff.js?v=39063c1';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=39063c1';   // instance config + chapter manifest; assistant-free by construction
