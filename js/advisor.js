...
import { wordDiff } from './textdiff.js?v=b9cac24';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=b9cac24';   // instance config + chapter manifest; assistant-free by construction
