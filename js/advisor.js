...
import { wordDiff } from './textdiff.js?v=71aa0f4';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=71aa0f4';   // instance config + chapter manifest; assistant-free by construction
