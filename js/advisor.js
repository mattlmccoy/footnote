...
import { wordDiff } from './textdiff.js?v=457e03f';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=457e03f';   // instance config + chapter manifest; assistant-free by construction
