...
import { wordDiff } from './textdiff.js?v=3d639c0';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=3d639c0';   // instance config + chapter manifest; assistant-free by construction
