...
import { wordDiff } from './textdiff.js?v=9a0e2bd';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=9a0e2bd';   // instance config + chapter manifest; assistant-free by construction
