...
import { wordDiff } from './textdiff.js?v=d0ee84d';
import { loadConfig, dataRepoParts } from './config.js?v=d0ee84d';   // instance config (data repo, chapters); assistant-free by construction
