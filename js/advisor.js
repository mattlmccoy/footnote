...
import { wordDiff } from './textdiff.js?v=753cd31';
import { loadConfig, dataRepoParts, loadChapters } from './config.js?v=753cd31';   // instance config + chapter manifest; assistant-free by construction
