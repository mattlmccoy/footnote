...
import { wordDiff } from './textdiff.js?v=8abaf13';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=8abaf13';   // instance config + chapter manifest; assistant-free by construction
