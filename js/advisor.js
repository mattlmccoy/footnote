...
import { wordDiff } from './textdiff.js?v=632c317';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=632c317';   // instance config + chapter manifest; assistant-free by construction
