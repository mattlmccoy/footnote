...
import { wordDiff } from './textdiff.js?v=b29f773';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams, workspaceInviteBroken } from './config.js?v=b29f773';   // instance config + chapter manifest; assistant-free by construction
