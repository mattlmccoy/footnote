...
import { wordDiff } from './textdiff.js?v=f481d1d';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=f481d1d';   // instance config + chapter manifest; assistant-free by construction
