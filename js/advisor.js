...
import { wordDiff } from './textdiff.js?v=41b8e38';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=41b8e38';   // instance config + chapter manifest; assistant-free by construction
