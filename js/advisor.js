...
import { wordDiff } from './textdiff.js?v=65acd14';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=65acd14';   // instance config + chapter manifest; assistant-free by construction
