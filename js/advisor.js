...
import { wordDiff } from './textdiff.js?v=1f08e80';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=1f08e80';   // instance config + chapter manifest; assistant-free by construction
