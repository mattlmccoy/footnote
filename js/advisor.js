...
import { wordDiff } from './textdiff.js?v=d4e04d6';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=d4e04d6';   // instance config + chapter manifest; assistant-free by construction
