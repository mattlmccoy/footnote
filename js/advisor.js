...
import { wordDiff } from './textdiff.js?v=76919ff';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=76919ff';   // instance config + chapter manifest; assistant-free by construction
import { keyFromSearch, searchWithoutKey } from './invite.js?v=76919ff';   // magic-link: key in the invite URL
import { makeSafeStore } from './safestore.js?v=76919ff';   // never-throw storage so a blocked browser can't kill boot (F4)
import { orderedUnits, mergeReviews as flattenReviews, routeWrite, wrapUnit, stripSegmentId } from './wholedoc.js?v=76919ff';   // whole-document reader mirror (used on render + comment paths) — DO NOT drop; a bad merge once did and broke the reviewer
import { startWatch as startNetWatch } from './netstatus.js?v=76919ff';
import { fetchWithTimeout, classifyGitHubError, retryAfterMs, TTLCache, orphanComments } from './nethelpers.js?v=76919ff';   // bounded fetch + rate-limit backoff + read cache + orphan fallback
startNetWatch();
