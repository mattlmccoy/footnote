...
import { wordDiff } from './textdiff.js?v=proj1';
import { loadConfig, dataRepoParts, loadChapters } from './config.js?v=proj1';   // instance config + chapter manifest; assistant-free by construction
