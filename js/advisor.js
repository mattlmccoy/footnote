...
import { wordDiff } from './textdiff.js?v=94173a2';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=94173a2';   // instance config + chapter manifest; assistant-free by construction
import { keyFromSearch, searchWithoutKey } from './invite.js?v=94173a2';   // magic-link: key in the invite URL
