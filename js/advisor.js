...
import { wordDiff } from './textdiff.js?v=8f3709b';
import { loadConfig, dataRepoParts, loadChapters } from './config.js?v=8f3709b';   // instance config + chapter manifest; assistant-free by construction
