...
import { wordDiff } from './textdiff.js?v=49c7749';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=49c7749';   // instance config + chapter manifest; assistant-free by construction
