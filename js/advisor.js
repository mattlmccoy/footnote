...
import { wordDiff } from './textdiff.js?v=97805eb';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=97805eb';   // instance config + chapter manifest; assistant-free by construction
