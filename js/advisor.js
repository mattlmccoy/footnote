...
import { wordDiff } from './textdiff.js?v=495746b';
import { loadConfig, dataRepoParts, loadChapters, setConfig, dataRepoFromParams } from './config.js?v=495746b';   // instance config + chapter manifest; assistant-free by construction
import { orderedUnits, mergeReviews as flattenReviews, routeWrite, wrapUnit, stripSegmentId } from './wholedoc.js?v=495746b';   // whole-document view helpers (pure)
