...
import { loadConfig, loadProjects, normalizeProject } from './config.js?v=3d639c0';
import { seedDataRepo } from './seed.js?v=3d639c0';
import { importFormat, sourceRepoSuggestion, ensureRepo, commitSourceFile } from './importdoc.js?v=3d639c0';
