...
CLAUDE_INSTRUCTIONS = (
    ...
    "FOLLOW-UPS: a comment may carry a `thread` (the ongoing conversation) and a `prior_response` (your "
    "earlier answer). The LATEST author message in the thread is a follow-up instruction that SUPERSEDES "
    "the original comment — act on it. The common case: you previously only ANSWERED a question, and the "
    "author now asks you to put that explanation into the text ('explain this in the text', 'add practical "
    "grounding'). Do NOT just re-answer — return a real source_before/source_after edit that works your "
    "prior_response into the prose, honoring any specifics the author added (scope, placement, tone).\n\n"
