...
\newcommand{\squared}{²}\newcommand{\cubed}{³}
%==============================================================================
%  preamble/macros.tex — shared math macros used across chapters.
%  These are the canonical definitions; section files (e.g. the HEATR methods)
%  \providecommand the same names, so those guards no-op when included here.
%==============================================================================

% --- RFAM / HEATR physics ---
% \ensuremath so these are safe in BOTH text and math mode (e.g. "\Tphi snapshot"
% in a caption no longer triggers "Missing $ inserted").
\newcommand{\Qrf}{\ensuremath{Q_{\mathrm{rf}}}}
\newcommand{\Tphi}{\ensuremath{T_{\varphi_{0.90}}}}
\newcommand{\sigT}{\ensuremath{\sigma_T}}
\newcommand{\rhorel}{\ensuremath{\rho_{\mathrm{rel}}}}
\newcommand{\phimelt}{\ensuremath{\varphi}}
\newcommand{\satmap}{\ensuremath{s(x,y)}}
\newcommand{\Tpc}{\ensuremath{T_{\mathrm{pc}}}}
\newcommand{\bndstd}{\ensuremath{\sigma_{\mathrm{bnd}}}}

% --- Geometry / compensation ---
\newcommand{\EPE}{\ensuremath{\mathrm{EPE}}}
\newcommand{\Leff}{\ensuremath{L_{\mathrm{eff}}}}
\newcommand{\RMSE}{\ensuremath{\mathrm{RMSE}}}

% --- Figure placeholder (TODO art still to be produced) ---
% Visible boxed placeholder so missing figures are obvious in the compiled PDF
% and greppable in source. Swap \figtodo{...} for \includegraphics when ready.
% Usage: inside a figure env, \figtodo{what to show + source path}.
\newcommand{\figtodo}[1]{%
  \setlength{\fboxsep}{10pt}%
  \fbox{\begin{minipage}[c][0.30\textheight][c]{0.86\linewidth}%
    \centering\itshape\small \textbf{TODO (figure):}\\[0.4em] #1%
  \end{minipage}}}
...
\newcommand{\iter}[1]{\textnormal{iter-}#1}
